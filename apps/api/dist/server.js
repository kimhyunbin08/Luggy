...
const policyVersions = new Map([['v1', defaultPolicy]]);
const carriers = [{ id: 'c1', size: 'carry_on', optIn: true, available: true, quantity: 5 }];
...
export function createApp() {
    ...
    app.post('/webhooks/delivery', (req, res) => {
        ...
        if (parsed.status === 'in_transit')
            booking.status = 'outbound_in_transit';
